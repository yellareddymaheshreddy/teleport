                    ...
                    <div className="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
                        ...
                        <div className="my-8 flex items-center justify-center gap-6 space-x-2">
                            <div className='flex gap-2'>
                                ...
                                <div className='bg-gradient-to-r from-indigo-500 to-pink-500 p-[2px] rounded-full h-max'>
                                <button
                                    onClick={() => {
                                        navigate("/add-ride")
                                    }}
                            ...
                            <div className='flex gap-2 flex-row-reverse'>
                                ...
                                <div className='p-[2px] bg-gradient-to-r from-indigo-500 to-pink-500 rounded-full h-max'>
                                <button
                                    onClick={() => {
                                        navigate("/all-rides");
                                    }}
